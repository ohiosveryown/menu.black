<template>
  <main class="wrapper">
    ...
    <header class="mb-5">
      ...
      <article>
        <p class="anim--enter f--us">menu.black is a growing collection of black-owned food spots in Atlanta. Don’t see a business in the collection that should be added? <a class="link" target="_blank" href="https://forms.gle/VeK4sspTLQUjYNLQA">Contact here</a> to add it to the list.</p>
      </article>
