<template>
  <section class="width">
    <h3 class="title uc">Feeling adventurous? Random
      ...
      <ul>
        <li class="" v-for="provision in shuffledProvisions" :key="provision.id">
...
<style lang="scss" scoped>
  ...
  ul {
    ...
    @include breakpoint(mdl) { margin-top: 5.2rem; justify-content: space-between; }
  }
  ...
  li {
    ...
    @include breakpoint(mdl) { flex: auto; }
  }
  ...
  li:last-of-type {
    display: none;
    @include breakpoint(lg) { display: inherit; }
  }
  ...
  h5 {
    ...
    text-align: center;
    display: none;
    @include breakpoint(md) { display: inherit; font-size: 2rem; }
  }
  ...
  @media(pointer: fine) { .refresh:hover {
    color: transparent;
